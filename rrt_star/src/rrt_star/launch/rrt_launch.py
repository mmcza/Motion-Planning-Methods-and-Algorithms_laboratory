...
def generate_launch_description():
    ...
    map_path = os.path.join(get_package_share_directory('rrt_star'), 'maps', 'map_medium.yaml')
    ...
    map_server_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('rrt_star'), 'launch', 'map_launch.py')
        ),
    ...
    rviz_config_dir = os.path.join(
        get_package_share_directory('rrt_star'), 'rviz', 'rviz_cfg.rviz')
